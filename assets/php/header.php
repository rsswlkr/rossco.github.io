				...
				<div class="nav-submenu">
					<div class="nav-item">
						...
						<div class="nav-submenu">
							...
							<a class="nav-link" target="_blank" href="https://bitshares.org/doxygen/">Doxygen</a> </div>
					</div>

					<div class="nav-item">
						<a class="nav-link" href="#">Native dApps<i class="fa fa-caret-right"></i></a>
						<div class="nav-submenu">
							<a class="nav-link" href="bitshares-dex.php" target="_blank">BitShares DEX</a>
							<a class="nav-link" href="bitshares-token-factory.php" target="_blank">BitShares Token Factory</a>
							<a class="nav-link" href="bts-token.php" target="_blank">BitShares Core Token</a>
						</div>
					</div>
